...
object DatabaseConnectionPool {
     ...
     */
    fun getConnection(profile: ConnectionProfile, decryptedPassword: String): Connection {
        val dataSource = pools.computeIfAbsent(profile.id) {
     ...
     */
    private fun createDataSource(profile: ConnectionProfile, password: String): HikariDataSource {
     ...
     */
    private fun buildJdbcUrl(profile: ConnectionProfile): String {
